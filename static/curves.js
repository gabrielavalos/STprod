...
function CurveLinear365Days(){
  ...
  var days366 = site_date.slice(0,366);
  var oil366 = site_oil.slice(0,366);
  var gas366 = site_gas.slice(0,366);
  var water366 = site_water.slice(0,366);
  var comments366 = comments.slice(0,366);
  //console.log(days365);
...
function Log365DayCurves(){
  ...
  var daysLog366 = site_date.slice(0,366);
  var oilLog366 = site_oil.slice(0,366);
  var gasLog366 = site_gas.slice(0,366);
  var waterLog366 = site_water.slice(0,366);
  var commentsLog366 = comments.slice(0,366);
...
d3.select("#Days360").on('click', CurveLinear365Days);
...
d3.select("#Days360Log").on('click', Log365DayCurves);
